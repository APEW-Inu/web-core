...
const CONFIG_SERVICE_CHAINS: ChainInfo[] = [
  ...
  {
    transactionService: 'https://transaction-ethw-safe.apewinu.com/',
    chainId: '10001',
    chainName: 'Ethereum PoW',
    shortName: 'ethw',
    l2: false,
    description: 'Ethereum PoW',
    rpcUri: { authentication: RPC_AUTHENTICATION.NO_AUTHENTICATION, value: 'https://mainnet.ethereumpow.org' },
    safeAppsRpcUri: { authentication: RPC_AUTHENTICATION.NO_AUTHENTICATION, value: 'https://mainnet.ethereumpow.org' },
    publicRpcUri: {
      authentication: RPC_AUTHENTICATION.NO_AUTHENTICATION,
      value: 'https://mainnet.ethereumpow.org',
    },
    blockExplorerUriTemplate: {
      address: 'https://mainnet.ethwscan.com/address/{{address}}',
      txHash: 'https://mainnet.ethwscan.com/tx/{{txHash}}',
      api: 'https://mainnet.ethwscan.com/api?module={{module}}&action={{action}}&address={{address}}&apiKey={{apiKey}}',
    },
    nativeCurrency: {
      name: 'ETH PoW',
      symbol: 'ETHW',
      decimals: 18,
      logoUri: 'https://s2.coinmarketcap.com/static/img/coins/64x64/21296.png',
    },
    theme: { textColor: '#ffffff', backgroundColor: '#FBC02D' },
    gasPrice: [{ type: GAS_PRICE_TYPE.FIXED, weiValue: '2000000000' }],
    disabledWallets: [
      'authereum',
      'coinbase',
      'fortmatic',
